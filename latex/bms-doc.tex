...
\title{User Manual for BMotion Studio}
\author{
Work in Progress\\
Handbook $ $Rev: 13274 $ $ \\
\\
\href{mailto:lukas.ladenberger@gmx.de}{lukas.ladenberger@gmx.de}\\
\href{http://cobra.cs.uni-duesseldorf.de/bmotionstudio}{http://cobra.cs.uni-duesseldorf.de/bmotionstudio}
}
