...
The transformer observer observes a list of expressions and triggers a function whenever a state change occurred.
...
\begin{tabular}{ l l l p{7cm} }
  ...
  \hline\noalign{\medskip}
  expressions & list / function* & empty list & Define a list of expressions that should be evaluated and passed to the trigger function. Example: $['x < 4', 'card(x)']$.\\
  \hline\noalign{\medskip}
