...
In Line 3 to 6 we define the event that should be executed after clicking on the corresponding floor label.
We use the content of the attribute \textit{data-floor} of the corresponding floor label in order to define the parameter/predicate.
