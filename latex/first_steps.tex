...
The \texttt{[id].json} file (id is your entered id just before) is the root file of your \bms\ visualization (also called \bms\ manifest file).
...
Example \texttt{script.js} file with a minimal configuration:
