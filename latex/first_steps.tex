...
To create a new visualization choose via the top menu: \textsf{File $\rangle$ New Visualization}.
A window will be opened asking you for some information.
Enter your data and press on OK.
Now, the tool asks you for a location (a folder) where you want to save your visualization.
After confirming, the tool creates a bunch of files in the folder:
